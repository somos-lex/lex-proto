...
namespace Lex.Api.Migrations
{
    ...
    [Migration("20260716085504_AjusteDefaultFechaCreacion")]
    partial class AjusteDefaultFechaCreacion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.MovimientoPago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("TrabajoHistorialId")
                        .HasColumnType("integer")
                        .HasColumnName("trabajo_historial_id");

                    b.HasKey("Id");

                    b.HasIndex("PagoId");

                    b.HasIndex("TrabajoHistorialId");

                    b.ToTable("movimiento_pago");
                });
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.Pago", b =>
                {
                    ...
                    b.Property<decimal>("MontoAEstudiante")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("monto_a_estudiante");

                    b.Property<decimal>("MontoComisionCalculada")
                        .HasPrecision(12, 2)
                        .HasColumnType("numeric(12,2)")
                        .HasColumnName("monto_comision_calculada");
                    ...
                    b.Property<decimal>("PorcentajeComisionLex")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasColumnName("porcentaje_comision_lex");
            ...
            modelBuilder.Entity("Lex.Api.Domain.Entities.MovimientoPago", b =>
                {
                    b.HasOne("Lex.Api.Domain.Entities.Pago", "Pago")
                        .WithMany("Movimientos")
                        .HasForeignKey("PagoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lex.Api.Domain.Entities.TrabajoHistorial", null)
                        .WithMany()
                        .HasForeignKey("TrabajoHistorialId")
                        .OnDelete(DeleteBehavior.Restrict);
